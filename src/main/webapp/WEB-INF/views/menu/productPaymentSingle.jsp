...
<body>
	<div class="order-box9">
		...
		<div class="container9">
			...
			<form action="<%=request.getContextPath()%>/directPayment" method="POST">
				<div class="product-box">
					<h4 class="">주문상품 확인</h4>
					<div class="table">
						<div class="top">				
							<ul>
								<li class="row1">제품번호</li>
								...
								<div class="middle">
									<ul>		
										...
										<li class="row5">
											<input type="hidden" name="order_cost" value="${orderCost}">
											<span>${orderCost}원</span>
										</li>							
										<li class="row6">무료</li>
									</ul>	
								</div>
						<div class="payment-info">
							<p class="p1">
								...
								<span class="total">${orderCost}</span>
								<strong>원</strong>
								<img src="<%=request.getContextPath()%>/resources/img/ico_sum2.png">
								<strong>총 배송비</strong>
							...
							<p class="p2">
								...
								<span class="total">${orderCost}</span>
								<input type="hidden" name="payment_cost" value="${orderCost}">
								<strong>원</strong>
							</p>
						</div>
					...
					<div class="btn-box1">
						<a href="<%=request.getContextPath()%>/"><img src="<%=request.getContextPath()%>/resources/img/btn_shopping.gif" alt=""></a>
